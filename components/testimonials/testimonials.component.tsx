...
const reviews = [
  ...
  },
  {
    name: "Jenny",
    username: "@jenny",
    body: "I'm at a loss for words. Ahnaf gave me a solid 2hr sex. His title Gay lord is legit",
  ...
  return (
    <figure
      className={cn(
        ...
        // light styles
        "border-zinc-900/[.1] bg-zinc-900/[.01] hover:bg-zinc-900/[.05]",
        // dark styles
...
export default function Testimonials() {
  return (
    <div className="relative flex h-[500px] w-full flex-col items-center justify-center overflow-hidden rounded-lg  bg-zinc-900 md:shadow-xl">
